...
CROSS JOIN input_embedding_view_pv AS A
ORDER BY A.token_id,B.type,B.head_id ,B.row_tile),
qkv_vector as (select r1.token_id, r1.type,r1.head_id,r1.row_tile as row_idx, (sum1+sum2+sum3+sum4+sum5+sum6+sum7+sum8)::Float as r from r1 positional join r2 positional join r3 positional join r4 
...
updated_embedding_local as (select df_embedding_delta.q_token_id as token_id,input.col_tile,element_sum(input.embedding,df_embedding_delta.delta) as embedding
